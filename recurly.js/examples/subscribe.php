...
<script>
  ...
  Recurly.buildSubscriptionForm({
    ...
    // in client libraries.
    signature: '<?php echo generateSignature() ?>',
  ...
  <body>
	...
	<div class="one-third last"><img src="https://www.lovetea.co/wp-content/uploads/2012/06/package-bag.jpg" alt="" title="LoveTea Bag" width="472" height="446" class="alignright size-full wp-image-712"><p></p>
	  <hr class="">
